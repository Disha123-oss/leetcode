...
<img style="width: 534px; height: 358px;" src="https://assets.leetcode.com/uploads/2019/01/30/tree1.png" alt="">
<pre><strong>Input:</strong> root = [0,1,2,3,4,3,4]
<strong>Output:</strong> "dba"
</pre>

<p><strong class="example">Example 2:</strong></p>
<img style="width: 534px; height: 358px;" src="https://assets.leetcode.com/uploads/2019/01/30/tree2.png" alt="">
<pre><strong>Input:</strong> root = [25,1,3,1,3,0,2]
<strong>Output:</strong> "adz"
</pre>

<p><strong class="example">Example 3:</strong></p>
<img style="height: 490px; width: 468px;" src="https://assets.leetcode.com/uploads/2019/02/01/tree3.png" alt="">
